...
set fanout_options_default="-l 200 -c 30"	;# blifFanout target maximum latency
						;# per gate 200ps, output load set to
						;# 50fF
set vesta_options_default="--long"
set addspacers_options_default="-stripe 5 150 PG"
